...
export function DocsPageClient() {
  ...
  const TOC = [
    ...
    { id: "features", label: p.features },
    { id: "how", label: p.how },
    { id: "ritual", label: p.ritual },
    { id: "getting-started", label: p.gettingStarted },
    { id: "modules", label: p.modules },
    { id: "install", label: p.install },
    { id: "contracts", label: p.contracts },
    { id: "faq", label: p.faq },
    { id: "stack", label: p.stack },
  ]
...
# (do not set DEPLOYER_* / SIGNER_PK)`}
            ...
            <article id="stack" className="scroll-mt-24">
              <SectionTitle kicker={p.stack} title={p.stack} />

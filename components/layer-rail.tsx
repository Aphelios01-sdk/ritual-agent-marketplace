...
export function LayerRail({ activeId }: { activeId?: string }) {
  ...
  return (
    <div className="border-b border-border/50 bg-card/30">
      <div className="page-container scrollbar-none flex items-center gap-1 overflow-x-auto py-2">
        <Link
          href="/layers"
          className={cn(
            "shrink-0 rounded-full px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-wider transition-colors",

...
/// @notice Redeploy AgentFactory only (using the Registry + JobMarket already on-chain).
///         Fixes the setAgentId double-call bug.
contract RedeployFactory is Script {
    // Addresses of already-deployed contracts (chain 1979)
